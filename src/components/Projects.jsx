...
const Projects = () => {
  ...
  const projectsData = {
    ...
    'wordpress': [
      ...
      {
        id: 7,
        title: 'Export Webinar Landing Page for BusyExim',
        description: 'Designed and developed a WordPress-based webinar landing page for BusyExim, focused on lead generation with responsive design and integrated contact forms.',
        image: be,
        link: 'https://busyexim.com/webinar-landing-page/'
      },
    ],
    'react': [
      {
